      ...
      <div className="container-custom">
        ...
        >
          ...
          <div className="absolute inset-0">
            <img src={heroImage} alt="Professional roofing services" className="h-full w-full object-cover" />
          ...
          <div className="relative px-4 py-12 text-center sm:px-6 md:px-12 md:py-24">
            ...
            <p className="mx-auto mb-8 max-w-xl text-primary-foreground/80">
              Garic Roofs delivers reliable roof repairs, restoration, and maintenance services across Melbourne.
              Backed by experienced tradespeople and quality materials, our solutions are built to withstand local
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Input
                  type="text"
                  name="address"
                  placeholder="Property Address (Suburb, Melbourne)"
            ...
            <p className="mt-8 text-sm text-primary-foreground/60">
              Your Roof, Restored with Quality, Precision &amp; Care
            </p>
          </div>
        </motion.div>
      </div>
